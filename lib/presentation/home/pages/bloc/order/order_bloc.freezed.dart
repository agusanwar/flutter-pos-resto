...
class _$LoadedImpl implements _Loaded {
  ...
  @override
  String toString() {
    return 'OrderState.loaded(items: $items, discount: $discount, tax: $tax, serviceCharge: $serviceCharge, paymentAmount: $paymentAmount)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(items, discount, tax, serviceCharge, paymentAmount);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(items, discount, tax, serviceCharge, paymentAmount);
  }
...
abstract class _Loaded implements OrderState {
  const factory _Loaded(
      ...
      final int tax,
      final int serviceCharge,
      final int paymentAmount) = _$LoadedImpl;
