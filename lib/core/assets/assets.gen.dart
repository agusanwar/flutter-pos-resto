...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/narve.png
  AssetGenImage get narve => const AssetGenImage('assets/images/narve.png');
...
class $AssetsLottiesGen {
  ...
  /// File path: assets/lotties/on-boarding1.json
  String get onBoarding1 => 'assets/lotties/on-boarding1.json';

  /// File path: assets/lotties/on-boarding2.json
  String get onBoarding2 => 'assets/lotties/on-boarding2.json';

  /// File path: assets/lotties/on-boarding3.json
  String get onBoarding3 => 'assets/lotties/on-boarding3.json';
